...
# Read the empty chamber dataset
empty_chamber <- read.csv("evrenselGasNorms1.csv")

# Read the individual soil test data (assuming you have them in separate CSV files)
soil_test1 <- read.csv("evrenselGasSoil1.csv")
soil_test2 <- read.csv("evrenselGasSoil2.csv")
soil_test3 <- read.csv("evrenselGasSoil3.csv")
soil_test4 <- read.csv("evrenselGasSoil4.csv")
